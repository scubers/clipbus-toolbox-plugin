...
.editor-panel__textarea:focus {
  /*
    Focus ring uses --pasty-accent so the highlight follows the host theme.
    The 3px outer glow keeps the original rgba fallback because --pasty-accent
    is opaque and we want soft transparency for the shadow.
  */
...
.editor-panel__toggle {
  ...
  padding: 6px 10px;
  border-radius: 999px;
  background: var(--pasty-surface-elevated, rgba(241, 245, 249, 0.92));
